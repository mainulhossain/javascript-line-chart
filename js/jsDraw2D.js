/*******************************************************************************
 * 
 * Project Name: jsDraw2D (Graphics Library for JavaScript) Version: Beta 1.0.0
 * (14-April-2009) (Compressed) Project Homepage: http://jsdraw2d.jsfiction.com
 * Author: Sameer Burle Copyright 2009: jsFiction.com (http://www.jsfiction.com)
 * Licensed Under: LGPL
 * 
...
function jsGraphics(k) {
	...
	function M(T) {
		if (A == "cartecian") {
			return new jsPoint(Math.round(T.x * F + L.x), Math.round(L.y - T.y
					* F))
		} else {
			return new jsPoint(Math.round(T.x * F + L.x), Math.round(T.y * F
					+ L.y))
		}
	}
	function C(ad, an, ah) {
